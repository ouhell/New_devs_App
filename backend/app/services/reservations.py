...
async def calculate_monthly_revenue(property_id: str, month: int, year: int, property_timezone: str = 'UTC', db_session=None) -> Decimal:
    ...
    Uses the property's timezone so reservations are attributed to the correct month.
    """
    ...
    print(f"DEBUG: Querying revenue for {property_id} from {start_date} to {end_date} [{property_timezone}]")
